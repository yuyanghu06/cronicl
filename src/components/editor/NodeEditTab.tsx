    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-bg-void border border-border-subtle rounded-xl px-3 py-2 font-narrative text-sm text-fg-bright outline-none focus:border-border-strong transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={6}
          className="w-full bg-bg-void border border-border-subtle rounded-xl px-3 py-2 font-narrative text-sm text-fg-bright leading-relaxed outline-none focus:border-border-strong transition-colors resize-y"
        />
      </div>
