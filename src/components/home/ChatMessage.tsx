...
export function ChatMessage({ variant, content }: ChatMessageProps) {
  if (variant === "user") {
    return (
      ...
      >
        <div className="bg-bg-raised border border-border-subtle rounded-lg px-4 py-2.5 max-w-md">
  ...
  return (
    <motion.div
      ...
      className="max-w-xl"
    >
      <DotMatrixText className="text-[10px] text-red mb-2 block tracking-[0.2em]">
        STORY_ARCHITECT
      </DotMatrixText>
